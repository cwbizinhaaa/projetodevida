...
// 1. ATUALIZADO: Datas alteradas para o futuro (2026/2027) para o cronômetro funcionar
const tempoObjetivo1 = new Date("2026-08-30T00:00:00");
const tempoObjetivo2 = new Date("2026-10-15T00:00:00");
...
function atualizaCronometro() {
    for (let i = 0; i < contadores.length; i++) {
        // Otimização: calcula o tempo uma vez por aba e guarda na variável
        const tempoCalculado = calculaTempo(tempos[i]);
       
        // 2. CORRIGIDO: Adicionado os índices [0], [1], [2], [3] correspondentes
